...
import { ShortDictDto } from '../../ServerService/shortDict.service';
...
export class ShortDictDialogComponent {
    constructor(
        @Inject(MAT_DIALOG_DATA) public data: ShortDictDto,
        private ref: MatDialogRef<ShortDictDialogComponent>
    ) { }
