...
} from "./chunk-5T2AWAIE.js";
import {
  SystemTimeService
} from "./chunk-MNF276XZ.js";
import "./chunk-WSLKGBQA.js";
import "./chunk-RWT4ZOKS.js";
import {
  MatProgressSpinner,
...
import "./chunk-QUPL34FG.js";
import {
  Router
} from "./chunk-RTUOVG6V.js";
import "./chunk-USFCJNJC.js";
import {
  MatDialog,
  MatDialogModule
...
function WelcomeComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "Soft Mode Active: Access Bypass Enabled");
    \u0275\u0275elementEnd()();
  }
}
...
var WelcomeComponent = class _WelcomeComponent {
  ...
  ngOnInit() {
    if (this.auth.isNeeds2FASetup()) {
      ...
      const dialogRef = this.dialog.open(TotpSetupDialogComponent, {
        disableClose: true,
        // Нельзя закрыть пока не завершена настройка
        width: "450px"
      });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WelcomeComponent, selectors: [["app-welcome"]], decls: 30, vars: 12, consts: [[1, "welcome-container"], [1, "welcome-card"], [3, "ngSubmit", "formGroup"], ["appearance", "outline", 1, "otp-field"], ["matInput", "", "type", "text", "formControlName", "code", "placeholder", "000000", "autocomplete", "one-time-code", "maxlength", "6"], ["matSuffix", ""], [1, "error-message"], [1, "debug-info"], [1, "actions"], ["mat-flat-button", "", "color", "primary", "type", "submit", 3, "disabled"], ["diameter", "20"], [1, "clock-footer"], [1, "utc-clock"]], template: function WelcomeComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(17, WelcomeComponent_Conditional_17_Template, 5, 0, "div", 7);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.auth.twoFactorMode() === "soft" && !ctx.isLoading() ? 17 : -1);
      \u0275\u0275advance(2);
  ...
  <mat-card class="welcome-card">
    ...
    <mat-card-content>
      <form [formGroup]="welcomeForm" (ngSubmit)="onSubmit()">
        ...
        @if (auth.twoFactorMode() === 'soft' && !isLoading()) {
          <div class="debug-info">
            <mat-icon>bug_report</mat-icon>
            <span>Soft Mode Active: Access Bypass Enabled</span>
          </div>
        }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WelcomeComponent, { className: "WelcomeComponent", filePath: "app/pages/welcome/welcome.component.ts", lineNumber: 34 });
})();
export {
  WelcomeComponent
};
//# sourceMappingURL=chunk-7YFGTZ5W.js.map
