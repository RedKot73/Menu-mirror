...
var AuthService = class _AuthService {
  ...
  needs2FASetup = signal(null, ...ngDevMode ? [{ debugName: "needs2FASetup" }] : []);
  ...
  isAuthenticated = computed(() => this.user() !== null && !this.requiresTwoFactor() && !this.isNeeds2FASetup(), ...ngDevMode ? [{ debugName: "isAuthenticated" }] : []);
  ...
  isNeeds2FASetup = computed(() => this.needs2FASetup() !== null, ...ngDevMode ? [{ debugName: "isNeeds2FASetup" }] : []);
...
//# sourceMappingURL=chunk-OM737Y4K.js.map
