...
// src/dictionaries/dictUnitTypes.component.ts
function DictUnitTypesComponent_th_10_Template(rf, ctx) {
  if (rf & 1) {
...
function DictUnitTypesComponent_td_11_Template(rf, ctx) {
  if (rf & 1) {
...
function DictUnitTypesComponent_th_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 13);
    \u0275\u0275text(1, "\u0421\u043A\u043E\u0440\u043E\u0447\u0435\u043D\u043D\u044F");
    \u0275\u0275elementEnd();
...
function DictUnitTypesComponent_td_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DictUnitTypesComponent_th_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 13);
    \u0275\u0275text(1, "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440");
    \u0275\u0275elementEnd();
...
function DictUnitTypesComponent_td_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DictUnitTypesComponent_th_19_Template(rf, ctx) {
  if (rf & 1) {
...
function DictUnitTypesComponent_td_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 14)(1, "button", 16);
    \u0275\u0275listener("click", function DictUnitTypesComponent_td_20_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function DictUnitTypesComponent_td_20_Template_button_click_4_listener() {
      const area_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r5 = \u0275\u0275nextContext();
...
function DictUnitTypesComponent_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 18);
  }
}
function DictUnitTypesComponent_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 19);
  }
}
var DictUnitTypesComponent = class _DictUnitTypesComponent {
  ...
  static \u0275fac = function DictUnitTypesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DictUnitTypesComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DictUnitTypesComponent, selectors: [["dict-unit-types"]], viewQuery: function DictUnitTypesComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  }, decls: 23, vars: 3, consts: [[1, "dict-page-container"], [1, "action-buttons"], ["mat-raised-button", "", "color", "primary", 3, "click"], ["mat-table", "", "matSort", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "value"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "shortValue"], ["matColumnDef", "comment"], ["matColumnDef", "actions"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-cell", ""], ["mat-icon-button", "", "color", "accent", 3, "click"], ["mat-icon-button", "", "color", "warn", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]], template: function DictUnitTypesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h2");
      \u0275\u0275text(2, "\u0422\u0438\u043F\u0438 \u043F\u0456\u0434\u0440\u043E\u0437\u0434\u0456\u043B\u0456\u0432");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 1)(4, "button", 2);
      \u0275\u0275listener("click", function DictUnitTypesComponent_Template_button_click_4_listener() {
        return ctx.reload();
      });
      \u0275\u0275text(5, "\u041E\u043D\u043E\u0432\u0438\u0442\u0438");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "button", 2);
      \u0275\u0275listener("click", function DictUnitTypesComponent_Template_button_click_6_listener() {
        return ctx.add();
      });
      \u0275\u0275text(7, "\u0421\u0442\u0432\u043E\u0440\u0438\u0442\u0438");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275template(10, DictUnitTypesComponent_th_10_Template, 2, 0, "th", 5)(11, DictUnitTypesComponent_td_11_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(12, 7);
      \u0275\u0275template(13, DictUnitTypesComponent_th_13_Template, 2, 0, "th", 5)(14, DictUnitTypesComponent_td_14_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(15, 8);
      \u0275\u0275template(16, DictUnitTypesComponent_th_16_Template, 2, 0, "th", 5)(17, DictUnitTypesComponent_td_17_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(18, 9);
      \u0275\u0275template(19, DictUnitTypesComponent_th_19_Template, 2, 0, "th", 10)(20, DictUnitTypesComponent_td_20_Template, 7, 0, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275template(21, DictUnitTypesComponent_tr_21_Template, 1, 0, "tr", 11)(22, DictUnitTypesComponent_tr_22_Template, 1, 0, "tr", 12);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DictUnitTypesComponent, [{
    type: Component,
    args: [{ selector: "dict-unit-types", imports: [MatTableModule, MatButtonModule, MatSortModule, MatIconModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DictUnitTypesComponent, { className: "DictUnitTypesComponent", filePath: "dictionaries/dictUnitTypes.component.ts", lineNumber: 56 });
})();
export {
  DictUnitTypesComponent
};
//# sourceMappingURL=chunk-BVOWAETB.js.map
