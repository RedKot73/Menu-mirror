...
// src/dictionaries/dictPosition.component.ts
function DictPositionComponent_th_10_Template(rf, ctx) {
  if (rf & 1) {
...
function DictPositionComponent_td_11_Template(rf, ctx) {
  if (rf & 1) {
...
function DictPositionComponent_th_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 12);
    \u0275\u0275text(1, "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440");
    \u0275\u0275elementEnd();
...
function DictPositionComponent_td_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DictPositionComponent_th_16_Template(rf, ctx) {
  if (rf & 1) {
...
function DictPositionComponent_td_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 13)(1, "button", 15);
    \u0275\u0275listener("click", function DictPositionComponent_td_17_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function DictPositionComponent_td_17_Template_button_click_4_listener() {
      const area_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
...
function DictPositionComponent_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 17);
  }
}
function DictPositionComponent_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 18);
  }
}
var DictPositionComponent = class _DictPositionComponent {
  ...
  static \u0275fac = function DictPositionComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DictPositionComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DictPositionComponent, selectors: [["dict-positions"]], viewQuery: function DictPositionComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  }, decls: 20, vars: 3, consts: [[1, "dict-page-container"], [1, "action-buttons"], ["mat-raised-button", "", "color", "primary", 3, "click"], ["mat-table", "", "matSort", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "value"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "comment"], ["matColumnDef", "actions"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-cell", ""], ["mat-icon-button", "", "color", "accent", 3, "click"], ["mat-icon-button", "", "color", "warn", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]], template: function DictPositionComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h2");
      \u0275\u0275text(2, "\u041F\u043E\u0441\u0430\u0434\u0438");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 1)(4, "button", 2);
      \u0275\u0275listener("click", function DictPositionComponent_Template_button_click_4_listener() {
        return ctx.reload();
      });
      \u0275\u0275text(5, "\u041E\u043D\u043E\u0432\u0438\u0442\u0438");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "button", 2);
      \u0275\u0275listener("click", function DictPositionComponent_Template_button_click_6_listener() {
        return ctx.add();
      });
      \u0275\u0275text(7, "\u0421\u0442\u0432\u043E\u0440\u0438\u0442\u0438");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275template(10, DictPositionComponent_th_10_Template, 2, 0, "th", 5)(11, DictPositionComponent_td_11_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(12, 7);
      \u0275\u0275template(13, DictPositionComponent_th_13_Template, 2, 0, "th", 5)(14, DictPositionComponent_td_14_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(15, 8);
      \u0275\u0275template(16, DictPositionComponent_th_16_Template, 2, 0, "th", 9)(17, DictPositionComponent_td_17_Template, 7, 0, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275template(18, DictPositionComponent_tr_18_Template, 1, 0, "tr", 10)(19, DictPositionComponent_tr_19_Template, 1, 0, "tr", 11);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DictPositionComponent, [{
    type: Component,
    args: [{ selector: "dict-positions", imports: [MatTableModule, MatButtonModule, MatSortModule, MatIconModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DictPositionComponent, { className: "DictPositionComponent", filePath: "dictionaries/dictPosition.component.ts", lineNumber: 54 });
})();
export {
  DictPositionComponent
};
//# sourceMappingURL=chunk-OFKZUPRW.js.map
