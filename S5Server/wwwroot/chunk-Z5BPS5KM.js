...
// src/dictionaries/dictTemplateCategories.component.ts
function DictTemplateCategoriesComponent_th_10_Template(rf, ctx) {
  if (rf & 1) {
...
function DictTemplateCategoriesComponent_td_11_Template(rf, ctx) {
  if (rf & 1) {
...
function DictTemplateCategoriesComponent_th_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 13);
    \u0275\u0275text(1, "\u0421\u043A\u043E\u0440\u043E\u0447\u0435\u043D\u043D\u044F");
    \u0275\u0275elementEnd();
...
function DictTemplateCategoriesComponent_td_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(category_r2.shortValue);
  }
}
function DictTemplateCategoriesComponent_th_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 13);
    \u0275\u0275text(1, "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440");
    \u0275\u0275elementEnd();
...
function DictTemplateCategoriesComponent_td_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(category_r3.comment);
  }
}
function DictTemplateCategoriesComponent_th_19_Template(rf, ctx) {
  if (rf & 1) {
...
function DictTemplateCategoriesComponent_td_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 14)(1, "button", 16);
    \u0275\u0275listener("click", function DictTemplateCategoriesComponent_td_20_Template_button_click_1_listener() {
      const category_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.edit(category_r5));
    });
    \u0275\u0275elementStart(2, "mat-icon");
    \u0275\u0275text(3, "edit");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "button", 17);
    \u0275\u0275listener("click", function DictTemplateCategoriesComponent_td_20_Template_button_click_4_listener() {
      const category_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.delete(category_r5));
    });
...
function DictTemplateCategoriesComponent_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 18);
  }
}
function DictTemplateCategoriesComponent_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 19);
  }
}
var DictTemplateCategoriesComponent = class _DictTemplateCategoriesComponent {
  ...
  static \u0275fac = function DictTemplateCategoriesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DictTemplateCategoriesComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DictTemplateCategoriesComponent, selectors: [["dict-template-categories"]], viewQuery: function DictTemplateCategoriesComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  }, decls: 23, vars: 3, consts: [[1, "dict-page-container"], [1, "action-buttons"], ["mat-raised-button", "", "color", "primary", 3, "click"], ["mat-table", "", "matSort", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "value"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "shortValue"], ["matColumnDef", "comment"], ["matColumnDef", "actions"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-cell", ""], ["mat-icon-button", "", "color", "accent", 3, "click"], ["mat-icon-button", "", "color", "warn", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]], template: function DictTemplateCategoriesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h2");
      \u0275\u0275text(2, "\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u0448\u0430\u0431\u043B\u043E\u043D\u0456\u0432 \u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u0456\u0432");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 1)(4, "button", 2);
      \u0275\u0275listener("click", function DictTemplateCategoriesComponent_Template_button_click_4_listener() {
        return ctx.reload();
      });
      \u0275\u0275text(5, "\u041E\u043D\u043E\u0432\u0438\u0442\u0438");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "button", 2);
      \u0275\u0275listener("click", function DictTemplateCategoriesComponent_Template_button_click_6_listener() {
        return ctx.add();
      });
      \u0275\u0275text(7, "\u0421\u0442\u0432\u043E\u0440\u0438\u0442\u0438");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275template(10, DictTemplateCategoriesComponent_th_10_Template, 2, 0, "th", 5)(11, DictTemplateCategoriesComponent_td_11_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(12, 7);
      \u0275\u0275template(13, DictTemplateCategoriesComponent_th_13_Template, 2, 0, "th", 5)(14, DictTemplateCategoriesComponent_td_14_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(15, 8);
      \u0275\u0275template(16, DictTemplateCategoriesComponent_th_16_Template, 2, 0, "th", 5)(17, DictTemplateCategoriesComponent_td_17_Template, 2, 1, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(18, 9);
      \u0275\u0275template(19, DictTemplateCategoriesComponent_th_19_Template, 2, 0, "th", 10)(20, DictTemplateCategoriesComponent_td_20_Template, 7, 0, "td", 6);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275template(21, DictTemplateCategoriesComponent_tr_21_Template, 1, 0, "tr", 11)(22, DictTemplateCategoriesComponent_tr_22_Template, 1, 0, "tr", 12);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DictTemplateCategoriesComponent, [{
    type: Component,
    args: [{ selector: "dict-template-categories", imports: [MatTableModule, MatButtonModule, MatSortModule, MatIconModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DictTemplateCategoriesComponent, { className: "DictTemplateCategoriesComponent", filePath: "dictionaries/dictTemplateCategories.component.ts", lineNumber: 59 });
})();
export {
  DictTemplateCategoriesComponent
};
//# sourceMappingURL=chunk-Z5BPS5KM.js.map
