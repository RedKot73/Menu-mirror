import {
  ShortDictService
} from "./chunk-A6KXFQFI.js";
import {
  VerticalLayoutComponent
} from "./chunk-CIZJCRTV.js";
import {
  S5App_ErrorHandler
} from "./chunk-UZD3JS7F.js";
import {
  MatSnackBar
} from "./chunk-34MCGZWS.js";
import {
  ShortDictDialogComponent
} from "./chunk-2MKTXZKF.js";
import {
...
// src/ServerService/dictCityCategory.service.ts
var DictCityCategoryService = class _DictCityCategoryService {
  api = "/api/dict-city-categories";
  ...
  static \u0275fac = function DictCityCategoryService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DictCityCategoryService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DictCityCategoryService, factory: _DictCityCategoryService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DictCityCategoryService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/dictionaries/dictCityCategory.component.ts
function DictCityCategoryComponent_th_16_Template(rf, ctx) {
  if (rf & 1) {
...
function DictCityCategoryComponent_td_17_Template(rf, ctx) {
  if (rf & 1) {
...
function DictCityCategoryComponent_th_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 14);
    \u0275\u0275text(1, "\u0421\u043A\u043E\u0440\u043E\u0447\u0435\u043D\u043D\u044F");
    \u0275\u0275elementEnd();
...
function DictCityCategoryComponent_td_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 15);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DictCityCategoryComponent_th_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 14);
    \u0275\u0275text(1, "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440");
    \u0275\u0275elementEnd();
...
function DictCityCategoryComponent_td_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 15);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DictCityCategoryComponent_th_25_Template(rf, ctx) {
  if (rf & 1) {
...
function DictCityCategoryComponent_td_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 15)(1, "button", 17);
    \u0275\u0275listener("click", function DictCityCategoryComponent_td_26_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function DictCityCategoryComponent_td_26_Template_button_click_4_listener() {
      const item_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r5 = \u0275\u0275nextContext();
...
function DictCityCategoryComponent_tr_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 19);
  }
}
function DictCityCategoryComponent_tr_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 20);
  }
}
var DictCityCategoryComponent = class _DictCityCategoryComponent {
  ...
  reload() {
    this.dictCityCategoryService.getAll().subscribe({
      ...
      error: (error) => {
        ...
        const errorMessage = S5App_ErrorHandler.handleHttpError(error, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u0437\u0430\u0432\u0430\u043D\u0442\u0430\u0436\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0439 \u043E\u0431'\u0454\u043A\u0442\u0456\u0432:");
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
        this.dictCityCategoryService.create(result).subscribe({
          next: () => {
            this.reload();
            this.snackBar.open("\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u044E \u043E\u0431'\u0454\u043A\u0442\u0430 \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u0441\u0442\u0432\u043E\u0440\u0435\u043D\u043E", "\u0417\u0430\u043A\u0440\u0438\u0442\u0438", { duration: 3e3 });
          },
          error: (error) => {
            console.error("\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u0441\u0442\u0432\u043E\u0440\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0430:", error);
            const errorMessage = S5App_ErrorHandler.handleHttpError(error, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u0441\u0442\u0432\u043E\u0440\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0430:");
            this.snackBar.open(errorMessage, "\u0417\u0430\u043A\u0440\u0438\u0442\u0438", { duration: 5e3 });
          }
        });
      }
  ...
  edit(cityCategory) {
    const dialogRef = this.dialog.open(ShortDictDialogComponent, {
      width: "400px",
      data: __spreadValues({}, cityCategory)
    });
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
        this.dictCityCategoryService.update(result.id, result).subscribe({
          next: () => {
            this.reload();
            this.snackBar.open("\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u044E \u043E\u0431'\u0454\u043A\u0442\u0430 \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u043E\u043D\u043E\u0432\u043B\u0435\u043D\u043E", "\u0417\u0430\u043A\u0440\u0438\u0442\u0438", { duration: 3e3 });
          },
          error: (error) => {
            console.error("\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u043E\u043D\u043E\u0432\u043B\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0430:", error);
            const errorMessage = S5App_ErrorHandler.handleHttpError(error, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u043E\u043D\u043E\u0432\u043B\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0430:");
            this.snackBar.open(errorMessage, "\u0417\u0430\u043A\u0440\u0438\u0442\u0438", { duration: 5e3 });
          }
        });
      }
    ...
    ref.afterClosed().subscribe((confirmed) => {
      if (confirmed) {
        this.dictCityCategoryService.delete(cityCategory.id).subscribe({
          next: () => {
            this.reload();
            this.snackBar.open("\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u044E \u043E\u0431'\u0454\u043A\u0442\u0430 \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043E", "\u0417\u0430\u043A\u0440\u0438\u0442\u0438", { duration: 3e3 });
          },
          error: (error) => {
            console.error("\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0430:", error);
            const errorMessage = S5App_ErrorHandler.handleHttpError(error, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043D\u044F \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0430:");
            this.snackBar.open(errorMessage, "\u0417\u0430\u043A\u0440\u0438\u0442\u0438", { duration: 5e3 });
          }
        });
      }
  ...
  static \u0275fac = function DictCityCategoryComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DictCityCategoryComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DictCityCategoryComponent, selectors: [["dict-city-categories"]], viewQuery: function DictCityCategoryComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  }, decls: 29, vars: 4, consts: [["actionPanel", ""], [1, "action-buttons"], ["mat-raised-button", "", "color", "primary", 3, "click"], ["contentPanel", ""], ["mat-table", "", "matSort", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "value"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "shortValue"], ["matColumnDef", "comment"], ["matColumnDef", "actions"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-cell", ""], ["mat-icon-button", "", "color", "accent", 3, "click"], ["mat-icon-button", "", "color", "warn", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]], template: function DictCityCategoryComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "app-vertical-layout")(1, "div", 0)(2, "h2");
      \u0275\u0275text(3, "\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0456\u0457 \u043E\u0431'\u0454\u043A\u0442\u0456\u0432 \u0430\u0434\u043C\u0456\u043D\u0456\u0441\u0442\u0440\u0430\u0442\u0438\u0432\u043D\u043E-\u0442\u0435\u0440\u0438\u0442\u043E\u0440\u0456\u0430\u043B\u044C\u043D\u0438\u0445 \u043E\u0434\u0438\u043D\u0438\u0446\u044C");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 1)(5, "button", 2);
      \u0275\u0275listener("click", function DictCityCategoryComponent_Template_button_click_5_listener() {
        return ctx.reload();
      });
      ...
      \u0275\u0275listener("click", function DictCityCategoryComponent_Template_button_click_9_listener() {
        return ctx.add();
      });
      ...
      \u0275\u0275template(16, DictCityCategoryComponent_th_16_Template, 2, 0, "th", 6)(17, DictCityCategoryComponent_td_17_Template, 2, 1, "td", 7);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(18, 8);
      \u0275\u0275template(19, DictCityCategoryComponent_th_19_Template, 2, 0, "th", 6)(20, DictCityCategoryComponent_td_20_Template, 2, 1, "td", 7);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(21, 9);
      \u0275\u0275template(22, DictCityCategoryComponent_th_22_Template, 2, 0, "th", 6)(23, DictCityCategoryComponent_td_23_Template, 2, 1, "td", 7);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(24, 10);
      \u0275\u0275template(25, DictCityCategoryComponent_th_25_Template, 2, 0, "th", 11)(26, DictCityCategoryComponent_td_26_Template, 7, 0, "td", 7);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275template(27, DictCityCategoryComponent_tr_27_Template, 1, 0, "tr", 12)(28, DictCityCategoryComponent_tr_28_Template, 1, 0, "tr", 13);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(14);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DictCityCategoryComponent, { className: "DictCityCategoryComponent", filePath: "dictionaries/dictCityCategory.component.ts", lineNumber: 87 });
})();
export {
  DictCityCategoryComponent
};
//# sourceMappingURL=chunk-ULNSXEL2.js.map
